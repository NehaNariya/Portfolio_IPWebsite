            ...
            <!--          <div class="row">
                 ...
                 <!--       <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" name="birthdate" class="form-control" id="dob" value="08-08-2000" autocomplete="off" placeholder="Please Enter DOB">
                ...
                <!--        <div class="row">
                  ...
                  <!--      <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <input type="file" name="profile" class="form-control"  autocomplete="off" placeholder="Please Profile" >
