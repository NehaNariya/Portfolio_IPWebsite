				...
				<div class="col-md-6">
					...
					<form action="" method="POST" enctype="multipart/form-data" onsubmit="return validation()">
						<div class="form-group">
							...
							<input type="email" name="username" class="form-control" id="user" autocomplete="off" placeholder="Enter username"><br/>
						...
						<div class="form-group form-check">
							<input type="checkbox" name="rememberme" class="form-check-input" id="exampleCheck1" value="<?= $check?>">
