          ...
          <div class="col-md-6 mb-6">
            ...
            <div class="col-md-6">
              <h1 class="text-dark text-center">Registration</h1><br/>
                ...
                <form enctype="multipart/form-data" action="registrationdata.php" method="post" name="registration" onsubmit="return validation()" >
                      
                  <div class="form-group">
                    <label for="username">Name</label>
                    <input type="email" name="username" class="form-control" id="user" value="nn@gmail.com" autocomplete="off" placeholder="username@gmail.com">
            ...
            <!--          <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" name="password" class="form-control" id="pass" value="nn882000" autocomplete="off" placeholder="Plase Enter Password">
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" name="re-password" class="form-control" id="repass" value="nn882000" autocomplete="off" placeholder="Please Enter Re-Password">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="age" class="form-control" id="age" value="22" autocomplete="off" placeholder="Please Enter Age">
                 ...
                 <!--       <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" name="Birth Date" class="form-control" id="dob" value="08-08-2000" autocomplete="off" placeholder="Please Enter DOB">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="Country" class="form-control" id="country" value="India" autocomplete="off" placeholder="Enter Country">
                ...
                <!--        <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="state" class="form-control" id="state" value="Gujarat" autocomplete="off" placeholder="Enter State">
                  ...
                  <!--      <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="city" class="form-control" id="city" value="Rajkot" autocomplete="off" placeholder="Enter City">
                  ...
                  <!--      <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <input type="file" name="image" class="form-control"  autocomplete="off" placeholder="Please Profile" >
              ...
              <!--     <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="note" value="Hello" autocomplete="off" placeholder="Enter Note"></textarea>
