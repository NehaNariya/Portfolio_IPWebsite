...
<div class="container">
 ...
 <table  class="table table-hover table-dark text-white" border="5" align="center" style="width:100%;" "height:100%;">
  ...
  <thead>
  <tr align="center" >
    <th colspan="12" style="margin-top:20px;" class="text-success text-center"><b><h3>Tutorial 10</h3></b> </th>
...
<!--    <th>No</th>-->
  ...
  <?php
            $sql = "select id,username,password,birthday,country,state,city from users";
    		$result = $db->query($sql);
        ...
        <tbody class="table table-dark text-dark">
            ...
            <tr>
                    ...
                    <td>
                        ...
                        <a href=""><button type="button" id="btn8" class="btn btn-danger">Delete</button>
                    </td> 
            </tr>
        </tbody>
            <?php
