<?php
	...
	$check=isset($_COOKIE['username'])?"checked":"";
?>
	...
	<div class="container">
			<div class="row content">
				...
				<div class="col-md-6">
					...
					<form action="validateuser.php" method="POST" enctype="multipart/form-data" onsubmit="return validation()">
						<div class="form-group">
							<label for="username">Username</label>
							<input type="email" name="username" class="form-control" id="user" value="<?= $user ?>" autocomplete="off" placeholder="Enter username"><br/>
                              <span id="username" class="text-danger font-weight-bold"></span>
						</div>
						
						<div class="form-group">
							<label for="password">Password</label>
							<input type="password" name="password" class="form-control"  id="pass" value="<?= $pass ?>" autocomplete="off" placeholder="Enter Password"><br/>
                             <span id="passwords" class="text-danger font-weight-bold"></span>
						</div>

						<div class="form-group form-check">
							<input type="checkbox" name="rememberme" class="form-check-input" <?= $check?> value="123">
